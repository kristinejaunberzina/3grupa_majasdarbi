    ...
    xhr2.open('GET', 'https://rezultati-spelei.armandspucs.repl.co/detektivs?vards='+vards+'&punkti='+punkti, true);
    xhr2.send();
    ...
    {
    xhr.open('GET', "https://rezultati-spelei.armandspucs.repl.co/detektivs", true);
    xhr.send();
